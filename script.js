...
// CONFIGURACIÓN
const CONFIG = {
  EMAILJS_PUBLIC_KEY: "2g5pXpVkRez0Aak55",
  EMAILJS_SERVICE_ID: "service_1x6xyeb",
  EMAILJS_TEMPLATE_ID: "template_504oxnr",
...
async function saveVoteToSupabase(payload) {
  ...
  const res = await fetch(`${CONFIG.SUPABASE_URL}/rest/v1/votes`, {
    method: "POST",
    headers: {
